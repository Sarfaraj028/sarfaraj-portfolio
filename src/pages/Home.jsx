  ...
  return (
    <section id="home"className= 'home lg:w-full text-white flex flex-col md:flex-row justify-between items-center gap-4 text-lg'>
      <div className='home-text md:w-1/2 '>
        ...
        <button className='px-4 py-1 border-green-600 border-2 rounded-md mr-2'> <a href="/Sarfaraj-cv.pdf" download="Sarfaraj-cv.pdf">Download CV </a></button>
        <button className='px-4 py-1 bg-green-600 rounded-md'> <Link to='contact' smooth={true} duration={500} offset={-70}> Contact</Link></button>
      </div>
